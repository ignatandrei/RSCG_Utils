...
class ModelAppSettings
{
    public readonly string nameSpaceName;
    public readonly ClassModel[] classModels;

    public ModelAppSettings(string nameSpaceName,ClassModel[]  classModels)
    {
...
{
    public string GenerateFile(string content, string rootTypeName, string namespaceName)
    {
        ...
        var m = new ModelAppSettings(namespaceName, classModels.ToArray());
        ...
        //}, member => member.Name);
        string generatedCode = new RSCG_Utils.Json2Class.GenerateJson(m).Render() ;
